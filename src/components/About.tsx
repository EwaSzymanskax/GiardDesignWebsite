...
function About(){
    return(
        ...
        <img className="pt-5 lg:w-1/2 lg:pt-0 2xl:w-full" src={house} alt="dom" />
        <div className=" bg-green lg:pl-16 lg:w-1/2 xl:max-w-1/2 2xl:w-1/2">
